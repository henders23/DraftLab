...
import {
  BookOpen, Users, Calendar, Bot, Globe,
...
const NAV_ITEMS = [
  ...
  { to: '/community', icon: <Globe size={20} />,           label: 'Community' },
        ...
        <div className="bg-zinc-900 rounded-xl p-4 border border-zinc-800">
          <Link to="/profile" className="flex items-center gap-3 mb-3 group">
            ...
            <div className="min-w-0">
              <p className="text-sm font-medium text-white truncate group-hover:underline">{displayName}</p>
