  ...
  return (
    <section className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
      <div className="flex justify-between items-center mb-5">
        ...
        <Link to="/peer" className="text-sm text-yellow-400 hover:text-yellow-300 transition-colors">
          View all
        </Link>
      </div>
      ...
      <div className="p-4 bg-black/50 border border-zinc-800/50 rounded-xl">
        <div className="flex justify-between items-start mb-2">
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 rounded-full bg-yellow-400/20 text-yellow-400 flex items-center justify-center text-xs font-bold shrink-0">
              {request.initials}
            </div>
        ...
        <Link
          to="/peer"
          className="flex items-center justify-center gap-2 w-full py-2 bg-yellow-400/10 hover:bg-yellow-400/20 text-yellow-400 text-xs font-medium rounded-lg transition-colors border border-yellow-400/20"
        >
