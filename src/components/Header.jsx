      ...
      <div className="hidden md:flex items-center gap-2">
        {SHORTCUTS.map(({ to, icon, label }) => (
          <Link
            key={to}
            to={to}
            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-zinc-400 hover:text-white bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 rounded-full transition-colors"
          >
            {icon}
            {label}
          </Link>
